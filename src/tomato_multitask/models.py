...
TIMM_FALLBACKS: dict[str, list[str]] = {
    ...
    "convnextv2_base.fcmae_ft_in22k_in1k": ["convnextv2_base.fcmae_ft_in22k_in1k", "convnextv2_base", "convnext_base.fb_in22k_ft_in1k"],
    ...
    "eva02_small_patch14_336.mim_in22k_ft_in1k": ["eva02_small_patch14_336.mim_in22k_ft_in1k", "eva02_small_patch14_336"],
...
def create_timm_head_model(method_cfg: dict[str, Any], num_outputs: int, pretrained: bool) -> CreatedModel:
    import timm
...
def create_segmentation_model(method_cfg: dict[str, Any], num_classes: int, pretrained: bool) -> CreatedModel:
    framework = str(method_cfg.get("framework", "timm_fpn"))
