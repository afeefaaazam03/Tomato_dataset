...
from tomato_multitask.annotations import copy_result_artifacts, prepare_annotations
from tomato_multitask.config import load_config


def main() -> None:
    parser = argparse.ArgumentParser(description="Prepare RGB-image + mask + COCO annotations for the tomato benchmark.")
